# Study 2: Hierarchical Regression (Tables 13 and 14 / S4) ------------------
# Inputs:
#   - outputs/study2_clean.rds
# Outputs:
#   - outputs/study2_table13_hierarchical_regression_adolescents.csv
#   - outputs/study2_table14_hierarchical_regression_adults.csv
...
# Adolescents
build_table(df %>% filter(pid < 3000), "Adolescents", "study2_table14_hierarchical_regression_adolescents.csv")

# Adults
build_table(df %>% filter(pid > 3000), "Young Adults", "study2_table13_hierarchical_regression_adults.csv")

cat("Study 2 hierarchical regression tables written to outputs/.\n")
